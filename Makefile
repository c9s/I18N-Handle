# This Makefile is for the I18N::Handle extension to perl.
#
...
PARENT_NAME = I18N
DLBASE = $(BASEEXT)
VERSION_FROM = lib/I18N/Handle.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/I18N/Handle.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/I18N
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/I18N
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/I18N/Handle.pm $(INST_MAN3DIR)/I18N::Handle.$(MAN3EXT) 
